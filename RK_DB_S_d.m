% Diskreter Regelkreis RK_DB_S_d.m
...
figure ('Name', 'Fuehrung', 'NumberTitle', 'off', 'Position', [0 100 800 600]);
  ...
  axis ([0 T_E -1.1 1.1])
  title ('Dead-Beat-Fuehrungssprungantwort Fuehrung + Stoerung mit d=1', 'fontsize', 18)
  xlabel ('Zeit [s]')
  ylabel ('h(t)')
  legend ('w(t)', 'x(t)', 'y(t)')
  legend boxoff
...
figure ('Name', 'Stoerung', 'NumberTitle', 'off', 'Position', [200 200 800 600]);
  ...
  set (findobj (gcf, 'type', 'line'), 'LineWidth', 1);
  axis ([0 T_E -1.1 1.1])
  title ('Dead-Beat-Stoersprungantwort Fuehrung + Stoerung mit d=1', 'fontsize', 18)
  xlabel ('Zeit [s]')
  ylabel ('h(t)')
  legend ('z(t)', 'x(t)', 'y(t)')
  legend boxoff
...
figure ('Name', 'Pol-Nullstellen', 'NumberTitle', 'off', 'Position', [100 0 800 600]);
  ...
  axis ([-1 1 -1 1])
  title ('Dead-Beat-Pol-Nullstellenbild Fuehrung + Stoerung mit d=1', 'fontsize', 18)
  xlabel ('Realteil')
